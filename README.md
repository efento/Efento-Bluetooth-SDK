...
![iOS Badge](https://img.shields.io/badge/platform-Android-green) ![iOS Badge](https://img.shields.io/badge/platform-iOS-blue) [![Kotlin](https://img.shields.io/badge/kotlin-2.2.21-indigo)](http://kotlinlang.org) [![kotlinx-coroutines](https://img.shields.io/badge/kotlinx--coroutines-1.10.2-indigo)](http://kotlinlang.org) 
...
commonMain.dependencies {
    implementation("pl.efento.mobile:bluetooth:2.1.0")
}
```
